...
class Details13 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s13.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Паста-скраб для чищення волосся Davines  SOLU Sea Salt Scrub Cleanser, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1013</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Шампунь-скраб з морською сіллю. Він освіжає шкіру голови і видаляє домішки, залишки продуктів та забруднюючі частинки. Він надає текстуру волоссю і довше зберігає його в чистоті та світлі. Переможець Найкраще уточнююче лікування 2020, Здоров’я жінок.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Шампунь-скраб з морською сіллю. Він освіжає шкіру голови і видаляє домішки, залишки продуктів та забруднюючі частинки. Він надає текстуру волоссю і довше зберігає його в чистоті та світлі. Переможець Найкраще уточнююче лікування 2020, Здоров’я жінок.
                                    Ніжний скраб з морською сіллю.
                                    Він видаляє залишки та забруднюючі частинки зі шкіри голови та волосся.
                                    Текстуруючий ефект.
                                    Легке, м’яке волосся, яке довше залишається чистим.
                                    Натуральні активні інгредієнти.
                                </div>
                            </MDBTabPane>
