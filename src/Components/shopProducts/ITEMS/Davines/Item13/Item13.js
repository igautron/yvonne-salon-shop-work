...
class Item13 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details13'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s13.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Паста-скраб для чищення волосся Davines  SOLU Sea Salt Scrub Cleanser, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>
                                Засіб для чищення, скраб з морської солі SOLU. Паста з морської солі для глибокого очищення всіх типів волосся
                            </p>
                        </MDBLink>
