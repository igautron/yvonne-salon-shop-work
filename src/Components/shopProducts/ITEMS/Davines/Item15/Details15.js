...
class Details15 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s15.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь для очищення Davines  Purifying Shampoo, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1015</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Захист, салонний догляд, зволоження, очищення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Наш перший шампунь 100% Carbon Neutral, 98,2% біологічно розкладається з 95% інгредієнтами природного походження. Одномісний шампунь доброзичливий до планети та вашого волосся, м’яко очищаючи та зволожуючи. Переможець ELLE Green Beauty Stars 2020, Byrdie Eco Beauty Awards 202</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Наш перший шампунь 100% Carbon Neutral, 98,2% біологічно розкладається з 95% інгредієнтами природного походження. Одномісний шампунь доброзичливий до планети та вашого волосся, м’яко очищаючи та зволожуючи. Переможець ELLE Green Beauty Stars 2020, Byrdie Eco Beauty Awards 202
                                    Пропонує м’яке очищення.
                                    Забезпечує зволоження з еластичною дією.
                                    ullet Підходить для щоденного використання на всіх типах волосся.
                                    95% натурального походження * формула та 98,2% біологічно розкладається.
                                    100% натуральне походження * активні інгредієнти.
                                    100% натуральний аромат.
                                    Додані 100% натуральні консерванти.
                                    100% простежуваність інгредієнтів.
                                    Без барвників, силіконів або інгредієнтів тваринного походження.
                                </div>
                            </MDBTabPane>
