...
class Details18 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь для зволоження волосся, RENEWING Shampoo, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1018</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Ніжний шампунь, який допомагає підтримувати добробут шкіри голови та волосся, сприяючи їх довговічності.
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Ніжний шампунь, який допомагає підтримувати добробут шкіри голови та волосся, сприяючи їх довговічності.
                                    Система оновлення надає м’якіші, блискучі та повноцінні волосся.
                                    Стимуляція клітин шкіри.
                                    Противіковий та антиоксидантний ефект.
                                    М'якість волосся + 37%
                                    блиск волосся + 29%
                                    краса волосся + 29%
                                </div>
