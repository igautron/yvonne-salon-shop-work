...
class Item19 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details19'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s19.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь для зволоження волосся Davines REPLUMPING shampoo, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '> Еластичний та зволожуючий шампунь. Для надання волоссю неабиякої краси.
                            </p>
                        </MDBLink>
