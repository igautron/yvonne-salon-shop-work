...
class Item27 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details27'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s27.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь для зволоження волосся Davines SU Hair & Body Wash, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '> Зволожуючий та захисний шампунь для тіла та волосся під впливом сонця.
                            </p>
                        </MDBLink>
