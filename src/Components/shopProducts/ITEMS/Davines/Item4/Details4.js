                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s3.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь для кудрявого волосся Davines LOVE CURL Cleansing Cream, 500 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1004</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Шампунь та кондиціонер</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Виробник: <span className='font-weight-normal'>Davines</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>500 мл</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Захист, обє'м, салонний догляд, очищення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>
Все в одному шампунь та кондиціонер ідеально підходять для хвилястих до дуже кучерявих волосся. Це схоже на легкий очищаючий крем, який м’яко видаляє домішки і робить волосся надзвичайно м’якими.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Нанесіть рясне кількість засобу на вологе волосся, м’яко масажуючи.
                                    Залиште на 5 хвилин, потім змийте.
                                    Застосовувати кондиціонер не потрібно.
                                    Кожен третій шампунь чергуйте за допомогою шампуню та кондиціонера LOVE / Curl або маски для волосся.
                                </div>
                            </MDBTabPane>
