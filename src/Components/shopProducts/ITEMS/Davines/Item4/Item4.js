        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details4'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s3.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь для кудрявого волосся Davines LOVE CURL Cleansing Cream, 500 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '> Для сухого та ламкого волосся, для створення ідеальних завитків.
                            </p>
                        </MDBLink>
