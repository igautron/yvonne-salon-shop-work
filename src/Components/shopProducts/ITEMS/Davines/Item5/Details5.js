                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s5.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь для посилення завитків Davines LOVE CURL Shampoo, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1005</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Захист, об'єм,  догляд, очищення</span></p>
...
Вершковий шампунь для додання пружності кучерявим або хвилястим пасмам волосся. Зволожуюча формула очищає волосся, робить їх м’якими і легкими, збільшуючи об’єм, блиск і без шкоди для текстури.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Зволожуючий шампунь для хвилястого або кучерявого волосся.
                                    Еластичні і м’які локони.
                                    Це покращує обсяг і текстуру локонів або хвилястого волосся.
                                    Світле і блискуче волосся.
