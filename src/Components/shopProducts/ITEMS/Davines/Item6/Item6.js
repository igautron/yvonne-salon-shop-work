        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details5'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s6.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Делікатний шампунь Davines DEDE Shampoo, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Ніжний щоденний шампунь, що підходить для всіх типів волосся. Змиває бруд та жир.
                            </p>
                        </MDBLink>
