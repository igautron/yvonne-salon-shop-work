...
class Details9 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь для розгладжування Davines LOVE Shampoo, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1009</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Шампунь для кучерявого або неслухняного волосся для гладкого вигляду. Формула характеризується м’якою кремовою піною, призначеною для м’якого очищення кучерявого волосся, роблячи його гладким.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Шампунь для кучерявого або неслухняного волосся для гладкого вигляду. Формула характеризується м’якою кремовою піною, призначеною для м’якого очищення кучерявого волосся, роблячи його гладким.
                                    Ніжне очищення.
                                    Гладке, м’яке і блискуче волосся.
                                    Ефект проти завивання.
