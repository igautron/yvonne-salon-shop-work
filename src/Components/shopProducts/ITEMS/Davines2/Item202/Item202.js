...
class Item202 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details202'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s202.png')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 mt-0 w-100'>Молочко для краси волосся Davines OI All In One Milk, 135 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Залишкова багатофункціональна обробка спреєм
                            </p>
                        </MDBLink>
