...
class Item207 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details207'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s207.png')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Кондиціонер Davines MOMO, 250ml</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '> Зволожуючий кондиціонер для сухого або зневодненого волосся
                            </p>
                        </MDBLink>
