...
class Item213 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details213'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s213.png')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Кондиціонер Davines ALCHEMIC Conditioner Golden, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>
                                Підсилювач кольору кондиціонер для русявих тонів.
                            </p>
                        </MDBLink>
