...
class Details215 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s215.png')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Кондиціонер Davines ALCHEMIC Conditioner Chocolate, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1215</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Покращуючий колір кондиціонер для темно-коричневих або чорних тонів. Алхімічний кондиціонер-шоколад посилює та висвітлює ці природні або кольорові темно-коричневі відтінки.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Покращуючий колір кондиціонер для темно-коричневих або чорних тонів. Алхімічний кондиціонер-шоколад посилює та висвітлює ці природні або кольорові темно-коричневі відтінки.
                                </div>
                            </MDBTabPane>
