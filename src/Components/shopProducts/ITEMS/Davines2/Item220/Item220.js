...
class Item220 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details220'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s220.png')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Бальзам для волосся Davines WELLBEING Conditioner, 150 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>  Зволожуючий кондиціонер для всіх типів волосся.
                            </p>
                        </MDBLink>
