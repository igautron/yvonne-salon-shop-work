...
class Item229 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details229'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s229.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Ліквід для захисту волосся Davines Liquid Spell Reinforcing Bodifying Fluid, 125 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Рідка підсилююча рідина для волосся. Для захисту від шкідливих впливів.
                            </p>
                        </MDBLink>
