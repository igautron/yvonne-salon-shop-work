...
class Details230 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s230.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Серум для волосся Davines ENERGIZING Superactive, 100 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1230</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Серум</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>  Сироватка від випадіння волосся внаслідок андрогенетичних факторів.
Його формула покращує тон шкіри голови, контролює гіперпродукцію сироватки, зменшує випадання волосся, покращуючи щільність волосся.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Сироватка від випадіння волосся внаслідок андрогенетичних факторів.
                                    Його формула покращує тон шкіри голови, контролює гіперпродукцію сироватки, зменшує випадання волосся, покращуючи щільність волосся.
                                </div>
                            </MDBTabPane>
