...
class Item230 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details230'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s230.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Серум для волосся Davines ENERGIZING Superactive, 100 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Стимулююча сироватка для шкіри голови та тендітного волосся, схильного до випадіння.
                            </p>
                        </MDBLink>
