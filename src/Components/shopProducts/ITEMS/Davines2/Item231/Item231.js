...
class Item231 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details231'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s231.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Лосьйон для шкіри голови Davines ENERGIZING Seasonal Superactive, 100 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Сезонний лосьйон для шкіри голови та тендітного волосся, схильного до випадіння.
                            </p>
                        </MDBLink>
