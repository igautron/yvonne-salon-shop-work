...
class Item232 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details232'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s232.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Тонік для голови Davines ENERGIZING Thickening Tonic, 100 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '> Згущуючий тонік для тендітної шкіри голови та волосся, схильного до випадання.
                            </p>
                        </MDBLink>
