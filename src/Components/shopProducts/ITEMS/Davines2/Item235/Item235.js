...
class Item235 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details235'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s235.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 mt-0 w-100'>Крем для волосся Davines LOVE Hair Smoother, 150 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Розгладжуючий крем проти завивання для кучерявого або неслухняного волосся.
                            </p>
                        </MDBLink>
