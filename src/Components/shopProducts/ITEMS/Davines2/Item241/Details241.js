...
class Details241 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/s241.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Лосьйон Davines NOURISHING Hair Royal Jelly Superactive, 8 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1241</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>8 мл</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Лосьйон з маточним молочком для дуже зневодненої шкіри голови.
Він здійснює живильну та ремінералізуючу дію на шкіру голови з підбадьорливим ефектом на волосся.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Лосьйон з маточним молочком для дуже зневодненої шкіри голови.
                                    Він здійснює живильну та ремінералізуючу дію на шкіру голови з підбадьорливим ефектом на волосся.
                                </div>
                            </MDBTabPane>
