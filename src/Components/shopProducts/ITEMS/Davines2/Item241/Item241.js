...
class Item241 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details241'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/s241.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Лосьйон Davines NOURISHING Hair Royal Jelly Superactive, 8 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Мультиактивний комплекс, який є ремінералізуючим та вітамінним для шкіри голови
                            </p>
                        </MDBLink>
