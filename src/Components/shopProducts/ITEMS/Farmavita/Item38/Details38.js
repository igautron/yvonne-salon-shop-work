...
class Details38 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/f38.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Маска для волосся Farmavita AMETHYSTE Color Mask, 1000 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1038</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>1000 мл</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Захист, зволоження, оздоровлення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Кольорова захисна маска для фарбованого та мелірованого волосся. Захищає та підтримує інтенсивність кольору. Пасма волосся блискучі, м’які і легко розчісуються.

Вказівки:
після миття голови нанести на вологе волосся і зачесати. Залиште на 2-3 хвилини. Промити. Негайно промийте очі, якщо продукт контактує з ними. Професійний продукт.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Кольорова захисна маска для фарбованого та мелірованого волосся. Захищає та підтримує інтенсивність кольору. Пасма волосся блискучі, м’які і легко розчісуються.
                                    Вказівки:
                                    після миття голови нанести на вологе волосся і зачесати. Залиште на 2-3 хвилини. Промити. Негайно промийте очі, якщо продукт контактує з ними. Професійний продукт.
                                </div>
                            </MDBTabPane>
