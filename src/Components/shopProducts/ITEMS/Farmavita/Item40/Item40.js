...
class Item40 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details40'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f40.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Farmavita AMETHYSTE Silver Shampoo, 1000 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Захисний шампунь для волосся. Захищає та підтримує інтенсивність кольору. Волосся м’яке і шовковисте.
                            </p>
                        </MDBLink>
