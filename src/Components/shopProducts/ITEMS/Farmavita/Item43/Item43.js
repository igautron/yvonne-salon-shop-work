...
class Item43 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details43'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f43.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Маска Farmavita AMETHYSTE Hydrate Velvet Mask, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Поживна маска для сухого волосся. Забезпечує глибоке живлення та вологу волокнам волосся для оксамитового відчуття від коренів до кінців. Волосся блискучі, м’які і легко розчісуються.
                            </p>
                        </MDBLink>
