...
class Details44 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Маска Farmavita AMETHYSTE Hydrate Velvet Mask, 1000 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1044</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зволоження, живлення, оздоровлення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Поживна маска для сухого волосся. Забезпечує глибоке живлення та вологу волокнам волосся для оксамитового відчуття від коренів до кінців. Волосся блискучі, м’які і легко розчісуються.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Поживна маска для сухого волосся. Забезпечує глибоке живлення та вологу волокнам волосся для оксамитового відчуття від коренів до кінців. Волосся блискучі, м’які і легко розчісуються.
                                </div>
                            </MDBTabPane>
