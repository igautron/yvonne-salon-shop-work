...
class Item44 extends React.Component {
            ...
            <MDBCard className='border-0' >
                <Link to='/details44'
                    ...
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Farmavita AMETHYSTE Hydrate Velvet Mask, 1000 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Служить для підвищення, нормалізації та укріплення імунітету організму людини.
                            </p>
                        </MDBLink>
