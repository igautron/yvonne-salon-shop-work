...
class Details45 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Ампули Farmavita AMETHYSTE Hidrate Luminescence Nutri Lotion, 10 а</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1045</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Лікування шкіри голови, зволоження, оздоровлення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Надлегкий лосьйон для сухого / чутливого волосся. Він забезпечує волоссю блискучу світність і вологу. Наповнений дорогоцінними білками кашеміру, ця розкішна процедура є секретом для красиво м’яких волосся, що виглядають як мерехтливі кристали.
</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Надлегкий лосьйон для сухого / чутливого волосся. Він забезпечує волоссю блискучу світність і вологу. Наповнений дорогоцінними білками кашеміру, ця розкішна процедура є секретом для красиво м’яких волосся, що виглядають як мерехтливі кристали.
                                </div>
                            </MDBTabPane>
