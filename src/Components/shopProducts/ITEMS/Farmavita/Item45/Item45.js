...
class Item45 extends React.Component {
            ...
            <MDBCard className='border-0' >
                <Link to='/details45'
                    ...
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Ампули Farmavita AMETHYSTE Hidrate Luminescence Nutri Lotion, 10 а</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Надлегкий лосьйон для сухого та чутливого волосся. Він забезпечує волоссю блискучу світність і вологу.
                            </p>
                        </MDBLink>
