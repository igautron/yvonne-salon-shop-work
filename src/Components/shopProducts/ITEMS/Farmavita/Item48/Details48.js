...
class Details48 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/f48.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Фарбувальна маска Farmavita AMETHYSTE Colouring Mask SILVER, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1048</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Фарбувальна маска</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Виробник: <span className='font-weight-normal'>Farmavita</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>250 мл</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Для дуже світлих русяво-сріблястих тонів. Нейтралізує непривабливі жовті відтінки сріблясто-білого волосся. Усуває залишки жовтого з дуже світло-русявих відблисків, перетворюючи їх на блискучий білий колір.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Багата фарбувальна маска, сформульована з високоефективними прямими пігментами, оживляє та посилює колір за кілька хвилин.
                                    Збагачене аргановою олією для надзвичайного живлення та блиску, робить волосся надзвичайно яскравими та м’якими. Фарбуюча маска «Аметист» ідеально підходить для:
                                    • оживлення та посилення косметичних кольорів між відвідуваннями салону;
                                    • створювати тимчасові тони в натуральних волоссі;
                                    • нейтралізують непривабливі жовті відтінки та покращують дуже світлі світлі відтінки

                                    Для дуже світлих русяво-сріблястих тонів. Нейтралізує непривабливі жовті відтінки сріблясто-білого волосся. Усуває залишки жовтого з дуже світло-русявих відблисків, перетворюючи їх на блискучий білий колір. Додатковий продукт: шампунь Аметист СРІБНИЙ.

                                    Вказівки: Після миття голови надіти відповідні рукавички, розподілити рівномірно на висушене рушником волосся та зробити масаж. Залиште на 5 хвилин. потім ретельно промити. Він не діє на відростання.
                                </div>
