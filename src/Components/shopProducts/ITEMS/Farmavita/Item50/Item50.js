...
class Item50 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details50'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f49.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Фарбувальна маска Farmavita AMETHYSTE Colouring Mask BLONDE, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Для русявих тонів. Підбадьорює золотисті відтінки волосся надаючи їм здорового вигляду.
                            </p>
                        </MDBLink>
