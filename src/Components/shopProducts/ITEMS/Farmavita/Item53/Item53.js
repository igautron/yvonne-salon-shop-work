...
class Item53 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details53'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f53.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Фарбувальна маска Farmavita AMETHYSTE Colouring Mask COPPER, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Для мідних тонів. Посилює та підсвічує мідні та теплі червоні тони.
                            </p>
                        </MDBLink>
