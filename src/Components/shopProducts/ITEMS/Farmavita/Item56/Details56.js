...
class Details56 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/а56.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Ампули Farmavita AMETHYSTE Stimulate Hair Loss Control Intensive Lotion, 10 a</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1056</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Об'єм, одоровлення, проти випадіння, себорегуляція</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Інтенсивний лосьйон. Удосконалена програма для витончення волосся та проти випадіння волосся.Створений разом із Planoxil RG та кератином забезпечує стимулюючий ефект шкіри голови. Додає обсягу. Волосся залишаються густішими.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Інтенсивний лосьйон. Удосконалена програма для витончення волосся та проти випадіння волосся.Створений разом із Planoxil RG та кератином забезпечує стимулюючий ефект шкіри голови. Додає обсягу. Волосся залишаються густішими.
                                </div>
                            </MDBTabPane>
