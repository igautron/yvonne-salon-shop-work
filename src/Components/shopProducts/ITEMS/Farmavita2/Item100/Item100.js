...
class Item100 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details100'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f100.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Маска Farmavita AMETHYSTE Purify Peeling Mask, 150 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Пілінг перед шампунем. Ця унікальна формула - це ексклюзивна комбінація високоефективних очищувальних засобів та спеціальних мікрошариків.
                            </p>
                        </MDBLink>
