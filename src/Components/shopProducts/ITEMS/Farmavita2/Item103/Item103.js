...
class Item103 extends React.Component {
            ...
            <MDBCard className='border-0' >
                <Link to='/details103'
                    ...
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Farmavita ARGAN SUBLIME Shampoo, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
