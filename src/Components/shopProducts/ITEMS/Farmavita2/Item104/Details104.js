...
class Details104 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1104</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Унікальний, цінний, живильний шампунь з арганової олії з інтенсивним екзотичним ароматом, створений для створення здорових, спокусливих, шовковистих пасм волосся.</span></p>
