...
class Details108 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/f108.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Farmavita ONELY The Dry Shampoo, 200 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1108</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Відновлення, зволоження, мінералізація</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'> Багатий шампунь для щоденного використання, наповнений рослинними оліями та екстрактами. Для всіх типів волосся.</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Багатий шампунь для щоденного використання, наповнений рослинними оліями та екстрактами. Для всіх типів волосся.
                                    1. Щоденне використання
                                    2. Насичена інфузія
                                    3. Додаткова шовковистість
                                    4. Захист кольору
                                    5. Контроль проти куріння
                                    6. Захист від ультрафіолету
                                    7. Підсилює блиск
                                    8. Врівноважує шкіру голови
                                    9. Зволожує
                                    10 Ревіталізує

                                    вказівки:
                                    нанести на вологе волосся, м’яко помасажувати і змити. Негайно промийте очі, якщо продукт контактує з ними.
