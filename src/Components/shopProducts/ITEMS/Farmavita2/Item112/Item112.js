...
class Item112 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details112'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f112.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Farmavita Color Shampoo N°01 - Fig and Almond, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Шампунь для захисту кольору для фарбованого волосся. Дбає про кожне пасмо роблячи його шовковистим.
                            </p>
                        </MDBLink>
