...
class Item115 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details115'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/f115.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Farmavita Gentle Shampoo N°03 - Oats and Lavender, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Щодня використовуйте ніжний шампунь для всіх типів волосся. Розкішне волосся гарантоване. Вибір для тих, хто цінить товари.
                            </p>
                        </MDBLink>
