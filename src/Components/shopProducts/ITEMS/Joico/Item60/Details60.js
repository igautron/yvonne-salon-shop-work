...
class Details60 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j60.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico Defy Damage Protective Shampoo, 300мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1060</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зміцнення, збереження кольору, очищення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Для зміцнення та довготривалості кольору. Ніжний щоденний миючий засіб швидко відмиває бруд та накопичення.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>600 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    ДЛЯ ЗМІЦНЕННЯ ТА КОЛЬОРОВОЇ ДОЛГОВІТНОСТІ
                                    Завдяки багатій розкішній піні з інгредієнтами, що запобігають пошкодженню, цей ніжний щоденний миючий засіб швидко відмиває бруд та накопичення, не обробляючи кутикулу волосся та не видаляючи яскравий колір. Результат: блискучі, гладкі, чисті пасма - чудово еластичні та здоровий вигляду.
                                </div>
                            </MDBTabPane>
