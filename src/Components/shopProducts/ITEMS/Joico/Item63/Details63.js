...
class Details63 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j63.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Незмиваючий догляд за волоссям Joico Defy Damage Protective Shield, 100 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1063</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Догляд</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Виробник: <span className='font-weight-normal'>Joico</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>100 мл</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Захист, догляд, зволоження</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Справжній герой захисту від наслідків щоденного укладання та впливу ультрафіолетових променів та забруднення навколишнього середовища - допомагає запобігти пошкодженню та захищає від вицвітання кольорів для красивих, живих, здорових на вигляд волосся. Застосовуване до укладання волосся укріплюється всередині та зовні.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>912 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Справжній герой захисту від суворих наслідків щоденного укладання та впливу ультрафіолетових променів та забруднення навколишнього середовища - допомагає запобігти пошкодженню та захищає від вицвітання кольорів для красивих, живих, здорових на вигляд волосся. Застосовуване до укладання волосся укріплюється всередині та зовні.
                                </div>
                            </MDBTabPane>
