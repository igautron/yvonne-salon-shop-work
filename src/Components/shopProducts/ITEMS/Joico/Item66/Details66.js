...
class Details66 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шамупнь Joico BLONDE LIFE VIOLET SHAMPOO, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1066</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Шамупнь</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Боротьба із жовтизною</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Шампунь фіолетовий для збереження яскравості Blonde Life Violet Shampoo Joico делікатно очищає шкіру голову і волосся.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>720 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Шампунь фіолетовий для збереження яскравості Blonde Life Violet Shampoo Joico делікатно очищає шкіру голову і волосся. Продукт призначений для нейтралізації небажаних жовтих відтінків блонда і збереженні яскравості кольору фарбованого волосся. Завдяки кератину, шампунь глибоко відновлює, живить і зволожує пасма.
                                </div>
                            </MDBTabPane>
