...
class Item67 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details67'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/j67.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Кондиціонер Joico BLONDE LIFE VIOLET SHAMPOO, 250 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Збереження яскравості, чистоти і краси блонда. Він містить фіолетовий пігмент, який забезпечує нейтралізацію жовтого відтінку.
                            </p>
                        </MDBLink>
