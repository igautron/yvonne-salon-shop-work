...
class Details70 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j70.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Олія Joico BLONDE LIFE OIL BRILLIANT GLOW BRIGHTENING OIL, 100 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1070</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Олія</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Блиск, розгладження, пом'якшення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Масло для діамантового блиску блонда має ультралегкі текстуру. Живить, розгладжує, захищає і знімає статику, захищає яскравість блонда. Комплекс масел і поживних амінокислот зволожує і живить волосся. Чистий формула масла не залишає сліду навіть в самому світлому блонді. Захищає від впливу UV-променів.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>1005 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Масло для діамантового блиску блонда має ультралегкі текстуру. Живить, розгладжує, захищає і знімає статику, захищає яскравість блонда. Комплекс масел і поживних амінокислот зволожує і живить волосся. Чистий формула масла не залишає сліду навіть в самому світлому блонді. Захищає від впливу UV-променів.
                                </div>
                            </MDBTabPane>
