...
class Details71 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Пінка Joico BRILLIANT TONE VIOLET SMOOTHING FOAM, 200 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1071</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Пінка</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Виробник: <span className='font-weight-normal'>Joico</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>200 мл</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зволоження, проти жовтизни, набуття відтінку</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Пінка для світлого волосся Joico Blonde Life Brilliant Tone Violet Smoothing Foam for Cool Blondes - інноваційний засіб подвійної дії, яке робить волосся пружними, надає їм рух і миттєво забарвлює їх в ніжний відтінок, усуваючи жовтизну одним нанесенням. Насичуючи волосся маслами моно і таману, невагома формула розгладжує і полірує кожен волосок і усуває кинута. В результаті світлий відтінок волосся стає неймовірно соковитим і красивим.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>1095 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    пінка для світлого волосся Joico Blonde Life Brilliant Tone Violet Smoothing Foam for Cool Blondes - інноваційний засіб подвійної дії, яке робить волосся пружними, надає їм рух і миттєво забарвлює їх в ніжний відтінок, усуваючи жовтизну одним нанесенням. Насичуючи волосся маслами моно і таману, невагома формула розгладжує і полірує кожен волосок і усуває кинута. В результаті світлий відтінок волосся стає неймовірно соковитим і красивим.
                                </div>
                            </MDBTabPane>
