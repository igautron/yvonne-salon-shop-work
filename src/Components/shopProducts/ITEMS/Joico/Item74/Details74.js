...
class Details74 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Кондиціонер Joico JOIFULL VOLUMIZING CONDITIONER, 250 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1074</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Догляд, зволоження, відновлення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Кондиціонер для обсягу JoiFull Volumizing Conditioner Joico має легку кремову текстуру. Формула продукту включає в себе унікальну технологію Oat Protein Complex, в основу якої закладені амінокислоти і гідролізований протеїн вівса та робить його шовковистим.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>640 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Кондиціонер для обсягу JoiFull Volumizing Conditioner Joico має легку кремову текстуру. Формула продукту включає в себе унікальну технологію Oat Protein Complex, в основу якої закладені амінокислоти і гідролізований протеїн вівса та робить його шовковистим.
                                </div>
                            </MDBTabPane>
