...
class Details75 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j74.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Стайлер Joico JOIFULL VOLUMIZING STYLER, 100 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1075</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'></span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Гібридний стайлер дарує бажаний обсяг і щільність вашому волоссю, які не обтяжуючи його.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>755 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Гібридний стайлер дарує бажаний обсяг і щільність вашому волоссю, які не обтяжуючи його. Після нанесення волосся м'які і шовковисте. Так само стайлер захищає від вологи і термічних ушкоджень (до 230). Завдяки особливій технології Oat Protein Complex ™ - комплекс амінокислот вівса і гидролизированного протеїну вівса, волосся стає щільніше по довжині і набуває природного обсяг біля кореня. Як і у всій продукції TM Joico в складі є кератин і аргеніні, який відновлюють структуру волосся. Вони, як і масло шипшини входять в Smart Release ™ технологію.
                                    Активні інгредієнти - кератин, аргінін і масло шипшини - укладені в ліпосом.
                                </div>
                            </MDBTabPane>
