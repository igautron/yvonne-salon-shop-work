...
class Details76 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico HYDRASPLASH HYDRATING SHAMPOO, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1076</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зволоження, догляд, блиск</span></p>
...
Ретельно очищає волосся, зберігаючи природну вологу. Залишає волосся м'якими і зволоженими. HydraSplash дарує тонким і середнім волоссю невагоме зволоження і делікатно живить пасма.
• 24-годинне зволоження.
• Волосся виглядають блискучими і здоровими всього після одного застосування.
• Чи не ускладнює.</span></p>
