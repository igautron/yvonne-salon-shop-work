...
class Details77 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Кондиціонер Joico HYDRASPLASH HYDRATING CONDITIONER, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1077</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Для тонкого волосся</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Кондиціонер Joico добре підходить для щоденного догляду за тонкими волоссям, схильними до сухості.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>690 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Зволожуючий кондиціонер для тонкого волосся Joico Hydrasplash Hydrating Conditioner - невагоме зволоження для балансу вологи і м'якості. Для тонких і середніх сухого волосся яким потрібен баланс вологи, блиск і м'якість.
                                    Ефект від використання:
                                    24-годинне зволоження
                                    Волосся виглядають блискучими і здоровими всього після одного застосування
                                    Чи не ускладнює
                                    Розплутує навіть дуже тонкі пасма,
                                    Залишає волосся м'якими і зволоженими.
                                </div>
                            </MDBTabPane>
