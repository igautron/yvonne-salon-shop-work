...
class Details78 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Маска Joico HYDRASPLASH GELÉE MASQUE, 150 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1078</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Маска</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Укріплення, зволоження, посилення блиску</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Зволожуюча маска для тонкого волосся Joico глибоко зволожує сухі, ламкі волосся. Продукт прекрасно ущільнює тонкі пасма. Основними компонентами є кокосова вода і морські водорості. </span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>870 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Зволожуюча маска для тонкого волосся Joico глибоко зволожує сухі, ламкі волосся. Продукт прекрасно ущільнює тонкі пасма. Основними компонентами є кокосова вода і морські водорості. Дані інгредієнти багаті на вітамін А, С і Е. Глибоко зволожують пасма, покращують еластичність. Засіб збільшує щільність тонкого волосся, покращує блиск і еластичність. Маска абсолютно не ускладнює волосся, підходить для частого використання. Застосування: нанести невелику кількість на вологе волосся на 5 хвилин. Потім ретельно змити водою.
                                </div>
                            </MDBTabPane>
