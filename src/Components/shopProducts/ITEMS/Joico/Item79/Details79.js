...
class Details79 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j79.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico HYDRASPLASH REPLENISHING LEAVE-IN, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1079</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зволоження, пом'якшення, очищення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Продукт відновлює гідроліпідний баланс шкіри голови. Основними компонентами є кокосова вода і морські водорості. Дані компоненти багаті на вітамін А, С і Е. Глибоко зволожують пасма, покращують еластичність. Збільшує щільність тонкого волосся, покращує блиск і еластичність. Шампунь абсолютно не ускладнює волосся, підходить для частого використання. Застосування: нанести невелику кількість на вологе волосся, спінити і ретельно змити водою.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>664 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Продукт відновлює гідроліпідний баланс шкіри голови. Основними компонентами є кокосова вода і морські водорості. Дані компоненти багаті на вітамін А, С і Е. Глибоко зволожують пасма, покращують еластичність. Збільшує щільність тонкого волосся, покращує блиск і еластичність. Шампунь абсолютно не ускладнює волосся, підходить для частого використання. Застосування: нанести невелику кількість на вологе волосся, спінити і ретельно змити водою.
                                </div>
                            </MDBTabPane>
