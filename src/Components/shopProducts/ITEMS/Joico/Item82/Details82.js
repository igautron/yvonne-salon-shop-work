...
class Details82 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/catalogue/j82.jpg')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico COLOR BALANCE BLUE SHAMPOO, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1082</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Нейтралізація жовтизни</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Створений для нейтралізації небажаних відтінків і підтримки холодного тону. В результаті використання шампуню волосся зберігають свою тональну цілісність і виглядають так, як ніби Ви щойно їх пофарбували в салоні краси.
                                        Для забезпечення максимального захисту кольору волосся рекомендуємо використовувати відтінку блакитний шампунь спільно з відтіночним кондиціонером блакитним.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>665 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Спеціальний комплекс Multi-Spectrum Defense Complex, який містить антиоксиданти, зелений чай, сонцезахисні фільтри, ідеально справляється з негативним впливом чинників навколишнього середовища, що викликають потускнение і вимивання кольору локонів.
                                    Збалансоване кількість синіх пімент відмінно справляється з нейтралізацією жовтих і оранжевих відтінків освітленого пасом брюнеток.
                                    Реконструює комплекс Bio-Advanced Peptide Complex ™, розроблений і запатентований Joico, сприяє відновленню пошкоджених, неживих волосся і попереджає їх повторне ушкодження. Повертається природний блиск і шовковистість.
                                </div>
                            </MDBTabPane>
