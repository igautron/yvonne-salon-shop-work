...
class Details84 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico K-PAK RECONSTRUCTING SHAMPOO, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1084</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Відновлення, зволоження, захист</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Шампунь спеціально розроблений для догляду за тьмяним волоссям, пошкодженими після хімічної і термічної обробки</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Шампунь спеціально розроблений для догляду за тьмяним волоссям, пошкодженими після хімічної і термічної обробки. (Кошти для укладання, прасування, плойки), а також в результаті вохдействія несприятливих факторів зовнішнього середовища (УФ, температура, дим і ін.). Шампунь відновлює і зволожує. Чи не вимиває колір фарбованого волосся. Має нейтральний рН: 4.5 - 5.5. Рекомендований для щоденного використання.
                                </div>
                            </MDBTabPane>
