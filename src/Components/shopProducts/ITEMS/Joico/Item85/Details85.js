...
class Details85 extends React.Component {
    state = {
        collapseID: ''
    }
                        ...
                        <div className='d-inline-flex '>
                            <MDBCol sm='6' md='6' lg='6' xl='5' className='m-0'>
                                <div className='p-1 m-0 p-2'>
                                    <img className='m-auto w-100 justify-content-center d-block' src={require('../../../../../img/categories/volosia/shampoo-tsitrus.png')} />
                                </div>
                            </MDBCol>
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Кондиціонер Joico K-PAK RECONSTRUCTING CONDITIONER, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1085</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Вид товару: <span className='font-weight-normal'>Кондиціонер</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Виробник: <span className='font-weight-normal'>Joico</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Об'єм: <span className='font-weight-normal'>300 мл</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Призначення: <span className='font-weight-normal'>Зволоження, захист, відновлення</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Тип шкіри: <span className='font-weight-normal'>Для усіх типів</span></p>
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Відновлювальний кондиціонер для пошкодженого волосся Joico K-Pak K-pak Conditioner To Repair Damage - інтенсивно зволожуючий кондиціонер для щоденного використання, відмінний засіб для зміцнення волосся і кінчиків волосся. Реконструює волосся зсередини, насичуючи їх амінокислотами, відновлює кутикулу. Полегшує розчісування і робить волосся більш стійкими до зовнішніх впливів. Після використання продукту волосся стає яскравими, блискучими і повними життєвих сил. pH: 4,5 - 5,5</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>770 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Відновлювальний кондиціонер для пошкодженого волосся Joico K-Pak K-pak Conditioner To Repair Damage - інтенсивно зволожуючий кондиціонер для щоденного використання, відмінний засіб для зміцнення волосся і кінчиків волосся. Реконструює волосся зсередини, насичуючи їх амінокислотами, відновлює кутикулу. Полегшує розчісування і робить волосся більш стійкими до зовнішніх впливів. Після використання продукту волосся стає яскравими, блискучими і повними життєвих сил. pH: 4,5 - 5,5
                                </div>
                            </MDBTabPane>
