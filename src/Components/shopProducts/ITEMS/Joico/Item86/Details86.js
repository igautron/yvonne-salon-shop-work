...
class Details86 extends React.Component {
    state = {
        collapseID: ''
    }
                    ...
                    <div className='pt-3'>
                        ...
                        <div className='d-inline-flex '>
                            ...
                            <MDBCol sm='6' md='6' lg='6' xl='7' className='p-2 m-0'>
                                <div className='p-2'>
                                    <h3 className='font-weight-normal'>Шампунь Joico K-PAK CLARIFYING SHAMPOO, 300 мл</h3>
                                    <p className='font-weight-bold py-1 m-0 grey-text'>Артикул:<span className='font-weight-normal'>1086</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0'>Опис: <span className='font-weight-normal'>Шампунь для глибокого очищення Joico K-pak Clarifying Shampoo без праці видалить залишки будь-яких мінералів, укладань, полімерів та інших небажаних забруднень на волоссі. Підходить для всіх типів волосся, крім недавно забарвлених. Не тільки добре видаляє шкідливі речовини на / в волоссі, але і відмінно зволожує і вирівнює структуру волосся. Шампунь має ніжну кремову формулу з нейтральним PH фактором: 4.5 - 5.5.</span></p>
                                    ...
                                    <p className='font-weight-bold py-1 m-0 price'>Ціна: <span className='font-weight-bold py-1 m-0'>675 грн</span></p>
                        ...
                        <MDBTabContent activeItem={this.state.items['default']} className='m-2 mb-5'>
                            <MDBTabPane tabId='1' className='mt-4'>
                                ...
                                <div className='item-method-of-use'>
                                    Шампунь для глибокого очищення Joico K-pak Clarifying Shampoo без праці видалить залишки будь-яких мінералів, укладань, полімерів та інших небажаних забруднень на волоссі. Підходить для всіх типів волосся, крім недавно забарвлених. Не тільки добре видаляє шкідливі речовини на / в волоссі, але і відмінно зволожує і вирівнює структуру волосся. Шампунь має ніжну кремову формулу з нейтральним PH фактором: 4.5 - 5.5. В результаті використання шампуню вологе волосся стають більш керованими і чудово розчісується. Знаходять гладкість і сяйво, чудово зволожуються і кондиціонують. При цьому відсутні будь-які неприємні відчуття, пов'язані з процедурою глибокого очищення.
                                </div>
                            </MDBTabPane>
