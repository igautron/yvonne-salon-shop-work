...
class Item86 extends React.Component {
        ...
        return (
            <MDBCard className='border-0' >
                <Link to='/details86'
                    ...
                    <MDBCardImage
                        src={require('../../../../../img/catalogue/j86.jpg')}
                        className='img-fluid w-100 prod-img'
                        alt=''>
                    </MDBCardImage>
                    <MDBCardBody className='w-responsive w-100 m-0 p-0 '>
                        <p className='prod-name text-left font-weight-bold pl-0 pb-0 mb-1 w-100'>Шампунь Joico K-PAK CLARIFYING SHAMPOO, 300 мл</p>
                        <MDBLink
                            color='primary'
                            href='!#'
                        ...
                        >
                            <p className='prod-describe black-text m-0 '>Шампунь для глибокого очищення Joico K-pak Clarifying Shampoo без праці видалить залишки будь-яких мінералів, укладань, полімерів та інших небажаних забруднень на волоссі.
                            </p>
                        </MDBLink>
